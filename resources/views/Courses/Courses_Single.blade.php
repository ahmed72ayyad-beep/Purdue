		...
		<div class="row">
			<div class="col-lg-8 col-sm-8 col-xs-12">
				<div class="single_event_single">
					<img alt="" class="img-fluid" src="{{asset('assets/images/all-img/c5.png')}}" />
					<div class="single_event_text_single">
						<h4>Professional Ceramic Moulding for Beginners</h4>
						<span><i class="fa fa-calendar"></i>10 Oct 2025</span>
							...
							<div class="overview">
								...
								<div class="details-buttons-area">
									...
									<ul class="social-icons">
										<li>
											<a href="#0" class="active"><i class="fa-brands fa-facebook"></i></a>
										</li>
										<li>
											<a href="#0"><i class="fa-brands fa-square-x-twitter"></i></a>
										</li>
										<li>
							...
							<div class="overview text-center">
								<div class="instructor-item">
									<div class="instructor-thumb">
										<a href="#0"><img src="{{asset('assets/images/all-img/ins-details.png')}}" alt="instructor"></a>
									</div>
							...
							<div class="client-review">
								<div class="review-comments">
									...
									<ul class="review-contents">
										<li>
											<div class="thumb">
												<img src="{{asset('assets/images/all-img/client04.png')}}" alt="course">
											</div>
											<div class="cont">
										...
										<li>
											<div class="thumb">
												<img src="{{asset('assets/images/all-img/client02.png')}}" alt="course">
											</div>
											<div class="cont">
										...
										<li>
											<div class="thumb">
												<img src="{{asset('assets/images/all-img/client03.png')}}" alt="course">
											</div>
											<div class="cont">
			...
			<div class="col-lg-4 col-sm-4 col-xs-12">
				...
				<div class="related_course">
					...
					<div class="single_rc">
						<div class="rc_img">
							<img src="{{asset('assets/images/all-img/rc-1.png')}}" alt="" />
						</div>
					...
					<div class="single_rc">
						<div class="rc_img">
							<img src="{{asset('assets/images/all-img/rc-2.png')}}" alt="" />
						</div>
						<i class="fa fa-star"></i>
						<i class="fa fa-star"></i>
						<i class="fa fa-star"></i>
					...
					<div class="single_rc">
						<div class="rc_img">
							<img src="{{asset('assets/images/all-img/rc-3.png')}}" alt="" />
						</div>
						<i class="fa fa-star"></i>
						<i class="fa fa-star"></i>
						<i class="fa fa-star"></i>
				...
				<div class="sidebar-post">
					...
					<div class="single_social">
						<ul>
							<li>
								<div class="social_item b_facebook"><a href="#" title="facebook"><i class="fa fa-facebook"></i><span class="item-list">150K Likes</span></a></div>
							</li>

							<li>
								<div class="social_item b_twitter"><a href="#" title="twitter"><i class="fa fa-twitter"></i><span class="item-list">138K Followers</span></a></div>
							</li>

							<li>
								<div class="social_item b_youtube"><a href="#" title="youtube"><i class="fa fa-youtube"></i><span class="item-list">90K Subscribers</span></a></div>
							</li>

							<li>
								<div class="social_item b_pinterest"><a href="#" title="pinterest"><i class="fa fa-pinterest"></i><span class="item-list">350K Followers</span></a></div>
							</li>

							<li>
								<div class="social_item b_tumblr"><a href="#" title="rss"><i class="fa fa-tumblr"></i><span class="item-list">901 Followers</span></a></div>
							</li>

							<li>
								<div class="social_item b_rss"><a href="#" title="rss"><i class="fa fa-rss"></i><span class="item-list">411 Followers</span></a></div>
							</li>
						</ul>
					</div><!-- END SOCIAL MEDIA POST -->
				</div><!-- END SIDEBAR POST -->

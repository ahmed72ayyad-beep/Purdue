...
<div class="bc_bg_two section-padding">
	<div class="container">
		<div class="section-title">
			...
			<h1>Choose Our New Courses </h1>
		</div>
		<div class="row">
			<div class="col-lg-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
				<div class="course-slide2">
					<div class="course-img2">
						<img src="{{asset('assets/images/course/1.jpg')}}" alt="">
			...
			<div class="col-lg-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
				<div class="course-slide2">
					<div class="course-img2">
						<img src="{{asset('assets/images/course/2.jpg')}}" alt="">
						<div class="course-date2">
			...
			<div class="col-lg-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
				<div class="course-slide2">
					<div class="course-img2">
						<img src="{{asset('assets/images/course/3.jpg')}}" alt="">
						<div class="course-date2">
			...
			<div class="col-lg-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
				<div class="course-slide2">
					<div class="course-img2">
						<img src="{{asset('assets/images/course/4.jpg')}}" alt="">
						<div class="course-date2">
			...
			<div class="col-lg-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
				<div class="course-slide2">
					<div class="course-img2">
						<img src="{{asset('assets/images/course/5.jpg')}}" alt="">
						<div class="course-date2">
			...
			<div class="col-lg-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
				<div class="course-slide2">
					<div class="course-img2">
						<img src="{{asset('assets/images/course/6.jpg')}}" alt="">
						<div class="course-date2">

		...
		<div class="row">
			<div class="col-lg-6 col-sm-12 col-xs-12">
				<div class="hero-text-img2">
					<img src="assets/images/all-img/home-img1.png" class="img-fluid" alt="" />
				</div>
			</div><!--- END COL -->
			<div class="col-lg-6 col-sm-12 col-xs-12">
	...
	<div class="container">
		<div class="row part_bg">
			...
			<div class="col-lg-8 col-sm-8 col-xs-12 text-center">
				<div class="partner">
					<a href="#"><img src="assets/images/clients/1.png" alt="image"></a>
					<a href="#"><img src="assets/images/clients/2.png" alt="image"></a>
					<a href="#"><img src="assets/images/clients/3.png" alt="image"></a>
					<a href="#"><img src="assets/images/clients/4.png" alt="image"></a>
					<a href="#"><img src="assets/images/clients/5.png" alt="image"></a>
					<a href="#"><img src="assets/images/clients/2.png" alt="image"></a>
					<a href="#"><img src="assets/images/clients/1.png" alt="image"></a>
					<a href="#"><img src="assets/images/clients/3.png" alt="image"></a>
					<a href="#"><img src="assets/images/clients/4.png" alt="image"></a>
...
<section class="category_two_area section-padding">
	<div class="container">
		<div class="section-title text-center">
			...
			<h1>Find the best courese from purdue by category</h1>
		</div>
		<div class="row">
		...
		<div class="row">
			...
			<div class="col-lg-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
				<div class="ab_content">
					...
					<a href="#" class="cta"><span>View All Courses</span>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-12 text-center">
				<div class="cc_btn">
					<a href="#" class="cta"><span>View All Course</span>
						<svg width="13px" height="10px" viewBox="0 0 13 10">
							<path d="M1,5 L11,5"></path>
							<polyline points="8 1 12 5 8 9"></polyline>
						</svg>
...
<section class="course_promo section-padding">
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s" data-wow-offset="0">
				<div class="cp_img">
					<img src="assets/images/all-img/about3.png" class="img-fluid" alt="image">
				</div>
			</div><!--- END COL -->
		</div><!--- END ROW -->
	</div><!--- END CONTAINER -->
		...
		<div class="row">
			<div class="col-lg-4 col-sm-4 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
				<div class="single_blog">
					<img src="assets/images/blog/1.jpg" class="img-fluid" alt="image" />
					<div class="img_info">
			...
			<div class="col-lg-4 col-sm-4 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
				<div class="single_blog">
					<img src="assets/images/blog/2.jpg" class="img-fluid" alt="image" />
					<div class="img_info">
			...
			<div class="col-lg-4 col-sm-4 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s" data-wow-offset="0">
				<div class="single_blog">
					<img src="assets/images/blog/3.jpg" class="img-fluid" alt="image" />
					<div class="img_info">
...
<section class="insfreecourse2 section-padding">
	<div class="container">
		<div class="row">
			<div class="col-lg-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s" data-wow-offset="0">
				<div class="single_ins2">
					<div class="single_ins_content2">

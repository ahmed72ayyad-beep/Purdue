        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s"
                    ...
                    <div class="contact">
                        <form class="form" method="post" action="{{ route('Home.Contact') }}"
                            onsubmit="return validation();">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <x-input class="form-control" name="name" placeholder="Your Name" />
                                    {{-- <input type="text" name="name" class="form-control" required="required" placeholder="Your Name"> --}}
                                </div>
                                <div class="form-group col-md-6">
                                    <x-input class="form-control" type="email" name="email" placeholder="Your Email" />
                                    {{-- <input type="email" name="email" class="form-control" required="required" placeholder="Your Email"> --}}
                                </div>
                                <div class="form-group col-md-12">
                                    <x-input class="form-control" name="subject" placeholder="Your subject" />
                                ...
                                <div class="col-md-12 text-center">
                                    <button href="#" class="cta"><span>Send Message</span>
                ...
                <div class="col-lg-5 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s"
                    data-wow-offset="0">
                    <div class="map">
                        <img style="width: 500px; border-radius: 20px;     box-shadow: 0px 1px 8px 0.5px #c5e6f5; overflow: hidden;"
                            src="{{ asset('assets/images/all-img/sarah-dorweiler-x2Tmfd1-SgA-unsplash.jpg') }}">
                    </div>
                </div><!-- END COL  -->
            </div><!-- END ROW -->
        </div><!--- END CONTAINER -->

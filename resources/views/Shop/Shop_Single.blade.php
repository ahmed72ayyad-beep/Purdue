            ...
            <div class="row">
                ...
                <div class="col-md-6 col-xs-12">
                    <div class="pd_img fix">
                        <a class="venobox" href="assets/images/shop/3.jpg"><img
                                src="{{ asset('assets/images/shop/3.jpg') }}" class="img-fluid" alt="" /></a>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-xs-12">
                    <div class="prdct_dtls_content">
                        ...
                        <div class="pd_text">
                            <h4>overview:</h4>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tem portul indunt ut
            ...
            <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="product-grid">
                        <div class="product-image">
                            <a href="#">
                                <img class="pic-1" src="{{ asset('assets/images/shop/1.jpg') }}" alt="Product Image">
                                <img class="pic-2" src="{{ asset('assets/images/shop/2.jpg') }}" alt="Product Image">
                            </a>
                            <ul class="social">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="product-grid">
                        <div class="product-image">
                            <a href="#">
                                <img class="pic-1" src="{{ asset('assets/images/shop/3.jpg') }}" alt="Product Image">
                                <img class="pic-2" src="{{ asset('assets/images/shop/4.jpg') }}" alt="Product Image">
                            </a>
                            <ul class="social">
                                <li><a href="" data-tip="Quick View"><i class="ti-zoom-in"></i></a></li>
                                <li><a href="" data-tip="Add to Wishlist"><i class="ti-bag"></i></a></li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="product-grid">
                        <div class="product-image">
                            <a href="#">
                                <img class="pic-1" src="{{ asset('assets/images/shop/5.jpg') }}" alt="Product Image">
                                <img class="pic-2" src="{{ asset('assets/images/shop/6.jpg') }}" alt="Product Image">
                            </a>
                            <ul class="social">
                                <li><a href="" data-tip="Quick View"><i class="ti-zoom-in"></i></a></li>
                                <li><a href="" data-tip="Add to Wishlist"><i class="ti-bag"></i></a></li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="product-grid">
                        <div class="product-image">
                            <a href="#">
                                <img class="pic-1" src="{{ asset('assets/images/shop/7.jpg') }}" alt="Product Image">
                                <img class="pic-2" src="{{ asset('assets/images/shop/8.jpg') }}" alt="Product Image">
                            </a>
                            <ul class="social">
                                <li><a href="" data-tip="Quick View"><i class="ti-zoom-in"></i></a></li>
                                <li><a href="" data-tip="Add to Wishlist"><i class="ti-bag"></i></a></li>

            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <table class="table shopping-summery">
                        ...
                        <tbody>
                            <tr>
                                <td class="image" data-title="No"><img src="{{ asset('assets/images/shop/cart1.jpg') }}"
                                        alt="#"></td>
                            ...
                            <tr>
                                <td class="image" data-title="No"><img src="{{ asset('assets/images/shop/cart2.jpg') }}"
                                        alt="#"></td>
                                <td class="product-des" data-title="Description">
                            ...
                            <tr>
                                <td class="image" data-title="No"><img src="{{ asset('assets/images/shop/cart3.jpg') }}"
                                        alt="#"></td>
                                <td class="product-des" data-title="Description">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-7 col-12">
                                <div class="right">
                                    ...
                                    <div class="button5">
                                        <a href="{{ route('Home.Shop.Checkout') }}" class="btn">Checkout</a>
                                        <a href="{{ route('Home.Shop') }}" class="btn">Continue shopping</a>
                                    </div>
                                </div>
                            </div>
                        </div>

            ...
            <div class="row">
                <div class="col-lg-8 col-12">
                    <div class="checkout-form">
                        ...
                        <form class="form" method="post" action="{{ route('Home.Shop.Checkout') }}">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <x-input type="number" name="number" label="Phone number" />
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        <label>Country<span>*</span></label>
                                        <select class="nice-select" name="country_name" id="country">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <select class="nice-select" name="state-province" id="state-province">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <x-input name="address1" label="Address Line 1" />
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        <x-input name="address2" label="Address Line 2" />
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        <x-input type="text" name="Postal" label="Postal Code" />
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        <label>Company<span>*</span></label>
                                        <select class="nice-select" name="company_name" id="company">

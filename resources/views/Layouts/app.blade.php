            ...
            <div class="container">
                <div class="row">
                    <div class="col-20 align-self-center">
                        <div class="site-logo">
                            <a href="{{route('Home')}}"><img src="{{asset('images/all-img/logo.png')}}" alt=""></a>
                        </div>
                    </div><!--- END Col -->
                        ...
                        <nav id="main-menu">
                            <ul>
                                ...
                                <li class="menu-item-has-children"><a href="#">Pages</a>
                                    <ul>
                                        <li><a href="{{route('Home.Pages.Instractors')}}">Instructor</a></li>
                                        <!-- <li><a href="{{route('Home.Pages.Instractors')}}">Instructor Details</a></li> -->
                                        <li><a href="{{route('Home.Pages.Events')}}">Event</a></li>
                                        <!-- <li><a href="event_single.html">Single Event</a></li> -->
                                        <li><a href="{{route('Home.Pages.Pricing')}}">Pricing Plan</a></li>
                                        <li><a href="{{route('Home.Pages.FAQ')}}">Faq Page</a></li>
                                        <li><a href="{{route('Home.Pages.Login')}}">Login Page</a></li>
                                        <li><a href="{{route('Home.Pages.Register')}}">Register</a></li>
                                ...
                                <li class="menu-item-has-children"><a href="{{route('Home.Blog')}}">Blog</a>
                                    <ul>
                                        ...
                                        <li>
                                            Blog Details
                                            <!-- <a href="{{route('Home.Blog')}}">Blog Details</a>-->
                                        </li>
                                    </ul>
                                </li>
                    ...
                    <div class="col-30 d-none d-xl-block text-end align-self-center">
                        ...
                        <div class="call_to_action">
                            <a class="btn_two" href="{{route('Home.Pages.Register')}}">Enroll Now <i class="fa-solid fa-arrow-right"></i></a>
